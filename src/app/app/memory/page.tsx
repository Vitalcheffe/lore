  ...
  return (
    <div className="h-full flex flex-col">
      {/* ═══════════════════════════════════════════════════════
          TOP BAR
          ═══════════════════════════════════════════════════════ */}
      <div className="bg-white dark:bg-[#0F0F12] border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] px-4 sm:px-6 lg:px-8 py-4 shrink-0">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-3">
          {/* Search */}
          <div className="relative flex-1 w-full sm:max-w-md">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#A1A1AA] dark:text-[#71717A]" />
            <Input
              placeholder="Search notes, bookmarks, insights..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-9 border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] bg-[#F9FAFB] dark:bg-[#09090B] focus-visible:ring-emerald-500/30 focus-visible:border-emerald-300 h-9"
            />
          </div>
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-all whitespace-nowrap ${
                  typeFilter === filter.value
                    ? 'bg-emerald-50 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-[rgba(16,185,129,0.20)]'
                    : 'text-[#71717A] dark:text-[#A1A1AA] hover:bg-[#F9FAFB] dark:hover:bg-[#18181B] hover:text-[#18181B] dark:hover:text-[#FAFAFA] border border-transparent'
                }`}
              >
                {filter.label}
              </button>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="flex items-center border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] rounded-lg overflow-hidden">
              <button
                onClick={() => setViewMode('grid')}
                className={`p-2 transition-colors ${
                  viewMode === 'grid'
                    ? 'bg-emerald-50 text-emerald-700 dark:text-emerald-400'
                    : 'text-[#71717A] dark:text-[#A1A1AA] hover:bg-[#F9FAFB] dark:hover:bg-[#18181B]'
                }`}
      ...
      <div className="flex-1 flex min-h-0">
        {/* ─── Categories Sidebar ──────────────────────── */}
        <aside className="hidden md:flex w-[220px] shrink-0 border-r border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[#0F0F12] flex-col">
          <div className="p-4">
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                      isActive
                        ? 'bg-emerald-50 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-[rgba(16,185,129,0.15)]'
                        : 'text-[#52525B] dark:text-[#D4D4D8] hover:bg-[#F9FAFB] dark:hover:bg-[#18181B] border border-transparent'
                    }`}
                  >
                    ...
                    <Badge
                      ...
                      className={`text-[10px] font-semibold h-5 min-w-[20px] justify-center ${
                        isActive
                          ? 'bg-emerald-100 dark:bg-[rgba(16,185,129,0.15)] text-emerald-700 dark:text-emerald-400'
                          : 'bg-gray-100 dark:bg-[#27272A] text-[#71717A] dark:text-[#A1A1AA]'
                      }`}
                    >
                      {cat.count}
                    </Badge>
        ...
        {/* ─── Notes Content ──────────────────────────── */}
        <main className="flex-1 overflow-y-auto bg-[#F9FAFB] dark:bg-[#09090B]">
            ...
            <div className="p-4 sm:p-6 lg:p-8 max-w-6xl">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full whitespace-nowrap transition-all ${
                      selectedCategory === cat.name
                        ? 'bg-emerald-50 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-[rgba(16,185,129,0.20)]'
                        : 'bg-white dark:bg-[#0F0F12] text-[#71717A] dark:text-[#A1A1AA] border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)]'
                    }`}
                  >
                    <span>{cat.emoji}</span>
                    {cat.name}
                    ...
                    >
                      <div className="flex-1 relative">
                        ...
                        <Input
                          ...
                          className="pl-9 h-8 text-sm border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] bg-[#F9FAFB] dark:bg-[#09090B] focus-visible:ring-emerald-500/30 focus-visible:border-emerald-300"
                        />
                      </div>
                      <Select value={quickType} onValueChange={(v) => setQuickType(v as NoteType)}>
                        <SelectTrigger className="w-[120px] h-8 text-xs border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)]">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
              ...
              <div className="flex items-center justify-between mb-4">
                <p className="text-xs text-[#71717A] dark:text-[#A1A1AA]">
                  <span className="font-semibold text-[#18181B] dark:text-[#FAFAFA]">{filteredNotes.length}</span>{' '}
                ...
                {selectedCategory !== 'All Notes' && (
                  <Button
                    ...
                    className="text-xs text-[#71717A] dark:text-[#A1A1AA] hover:text-[#18181B] dark:hover:text-[#FAFAFA] h-7"
                  >
              ...
              {loading && (
                <div className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="text-sm text-[#71717A] dark:text-[#A1A1AA]">Loading notes...</p>
                </div>
              )}
                  ...
                  {filteredNotes.map((note) => {
                    ...
                    if (viewMode === 'list') {
                      return (
                        ...
                        >
                          ...
                          >
                            <Card
                              className={`bg-white dark:bg-[#0F0F12] border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] hover:shadow-md hover:border-emerald-200 dark:hover:border-[rgba(16,185,129,0.20)] transition-all cursor-pointer group ${note.pinned ? 'border-l-4 border-l-amber-400' : ''}`}
                              ...
                              <CardContent className="p-4 flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-0.5">
                                    <h4 className="text-sm font-semibold text-[#18181B] dark:text-[#FAFAFA] truncate">
                                      {note.title}
                                    </h4>
                                    {note.pinned && (
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  ...
                                  <span className="text-[10px] text-[#A1A1AA] dark:text-[#71717A] whitespace-nowrap">
                                    {note.updatedAt}
                                  </span>
                                </div>
                              </CardContent>
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <Card
                            className={`bg-white dark:bg-[#0F0F12] border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] hover:shadow-md hover:border-emerald-200 dark:hover:border-[rgba(16,185,129,0.20)] transition-all cursor-pointer group h-full flex flex-col ${note.pinned ? 'border-l-4 border-l-amber-400' : ''}`}
                            style={!note.pinned ? { borderLeftWidth: '3px', borderLeftColor: config.color } : undefined}
                            onClick={() => handleCardClick(note)}
                          >
                            <CardContent className="p-5 flex flex-col flex-1">
                              ...
                              {/* Title */}
                              <h4 className="text-sm font-semibold text-[#18181B] dark:text-[#FAFAFA] mb-1.5 leading-snug group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
                                {note.title}
                              </h4>

                              {/* Content preview */}
                              <p className="text-xs text-[#71717A] dark:text-[#A1A1AA] leading-relaxed mb-3 line-clamp-3 flex-1">
                                {note.content}
                              </p>
                              ...
                              <div className="flex flex-wrap gap-1.5 mb-3">
                                {note.tags.slice(0, 3).map((tag) => (
                                  <span
                                    key={tag}
                                    className="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-medium bg-[#F3F4F6] dark:bg-[#27272A] text-[#52525B] dark:text-[#D4D4D8]"
                                  >
                                    {tag}
                                  </span>
                                ))}
                                {note.tags.length > 3 && (
                                  <span className="text-[10px] text-[#A1A1AA] dark:text-[#71717A] self-center">
                                    +{note.tags.length - 3}
                                  </span>
                                )}
                              </div>
                              ...
                              {/* Footer */}
                              <div className="flex items-center justify-between pt-2 border-t border-[#F3F4F6] dark:border-[rgba(255,255,255,0.04)]">
              ...
              {!loading && filteredNotes.length === 0 && notes.length > 0 && (
                <div className="flex flex-col items-center justify-center py-16">
                  <div className="w-14 h-14 rounded-2xl bg-[#F9FAFB] dark:bg-[#09090B] border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] flex items-center justify-center mb-4">
                    <Filter className="w-6 h-6 text-[#A1A1AA] dark:text-[#71717A]" />
                  </div>
                  <h3 className="text-sm font-semibold text-[#18181B] dark:text-[#FAFAFA] mb-1">No notes found</h3>
                  ...
                  <Button
                    ...
                    className="border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] text-xs"
                  >
                    Clear all filters
                  </Button>
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select value={newType} onValueChange={(v) => setNewType(v as NoteType)}>
                  <SelectTrigger className="border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="note">Note</SelectItem>
        ...
        <DialogContent className="sm:max-w-lg">
          {detailNote && (
            <>
              ...
              <div className="py-2">
                <p className="text-sm text-[#52525B] dark:text-[#D4D4D8] leading-relaxed whitespace-pre-wrap">
                  {detailNote.content}
                </p>
                {detailNote.sourceUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm text-emerald-600 hover:text-emerald-700 dark:hover:text-emerald-400 mt-2"
                  >
                ...
                {detailNote.tags.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-4">
                    {detailNote.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-[#F3F4F6] dark:bg-[#27272A] text-[#52525B] dark:text-[#D4D4D8]"
                      >
                        {tag}
                      </span>
                    ))}
